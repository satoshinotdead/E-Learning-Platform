...
echo "<script>window.location.href ='ajoutercours.php'</script>";
  }
  else
    {
...
<body>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="editeretudiant.php">Détails Cours</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>Cours </strong><small> Détails</small></div>
                            <form name="" method="post" action="" enctype="multipart/form-data">
                                
                            <div class="card-body card-block">
 
                                <div class="form-group"><label for="company" class=" form-control-label">Nom </label><input type="text" name="tname" value="" class="form-control" id="tname" required="true"></div>
                                <div class="form-group"><label for="company" class=" form-control-label">Photo </label><input type="file" name="propic" value="" class="form-control" id="propic" required="true"></div>
                                                                          
                                      
                                            <div class="row form-group">
                                                <div class="col-12">
                                                    <div class="form-group"><label for="city" class=" form-control-label">Niveau </label><input type="text" name="qualifications" id="qualifications" value="" class="form-control" required="true"></div>
                                                    </div>
   ...
   <div class="form-group"><label for="city" class=" form-control-label"> Description </label><textarea type="text" name="address" id="address" value="" class="form-control" rows="4" cols="12" required="true"></textarea></div>
                                                    ...
                                                    <div class="col-12">
                                                    <div class="form-group"><label for="city" class=" form-control-label"> Date Depot</label><input type="date" name="joiningdate" id="joiningdate" value="" class="form-control" required="true"></div>
                                                    </div>
